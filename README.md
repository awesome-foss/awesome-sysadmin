...
- [lldap](https://github.com/nitnelave/lldap) - Light (simplified) LDAP implementation with a simple, intuitive web interface and GraphQL support. ([Source Code](https://github.com/nitnelave/lldap)) `GPL-3.0` `Rust.
