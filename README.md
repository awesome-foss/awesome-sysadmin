...
- [Status](https://gitlab.com/dani3l0/status) - Simple and lightweight system monitoring tool with a pleasant web interface. ([Demo](https://status-ksk5.onrender.com/)) `MIT` `Python`
