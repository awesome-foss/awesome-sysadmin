...
- [Temps](https://temps.sh) - Self-hosted deployment platform with built-in analytics, error tracking, and managed databases. ([Source Code](https://github.com/gotempsh/temps)) `MIT` `Rust/Docker`
