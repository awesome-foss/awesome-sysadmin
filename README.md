...
- [Server Audit](https://audit.securecodehq.com/) - Automated security auditor for Linux VPS servers. Checks SSH, firewall, Docker, databases, credentials and active attacks. ([Source Code](https://github.com/Secure-Code-HQ/audit)) `MIT` `Shell`
