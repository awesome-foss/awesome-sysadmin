...
- [glances](https://github.com/nicolargo/glances) - Open-source, cross-platform real-time monitoring tool with CLI and web dashboard interfaces and many exporting options. `GPL-3.0` `Python`
