...
- [VictoriaMetrics](https://docs.victoriametrics.com/) - lightweight alternative to Prometheus. ([Source Code](https://github.com/VictoriaMetrics/VictoriaMetrics/) `Apache2` `Go`
