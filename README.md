...
* [Meli](https://github.com/getmeli/meli) - Self hosted platform for deploying static sites, frontend and single page applications. Automatic SSL, dynamic redirects, and more.
