...
- [Distr](https://distr.sh/) - Control plane to distribute applications to self-managed, BYOC, and on-prem environments.([Source Code](https://github.com/distr-sh/distr)) `Apache-2.0` `Go`
