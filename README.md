...
- [NETworkManager](https://borntoberoot.net/NETworkManager/) - A powerful Windows tool for managing and troubleshooting networks and servers via RDP, SSH, VNC, and more. ([Source Code](https://github.com/BornToBeRoot/NETworkManager)) `GPL-3.0` `C#/WPF`
