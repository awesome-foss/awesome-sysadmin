...
- [Databasement](https://github.com/David-Crty/databasement) - Database backup management tool supporting MySQL, MariaDB, PostgreSQL, MongoDB, SQLite, and Redis with scheduling, multiple storage backends, and cross-server restore. ([Demo](https://databasement-demo.crty.dev/), [Source Code](https://github.com/David-Crty/databasement)) `MIT` `Docker/PHP`
