...
- [Narrowlink](https://narrowlink.com/) - Narrowlink securely connects devices and services together, even when both nodes are behind separate NAT. ([Source Code](https://github.com/narrowlink/narrowlink)) `MPL-2.0` `AGPL-3.0` `Rust`
