...
- [tirreno](https://www.tirreno.com/) - An open-source SIEM to monitor and protect your web application from cyber fraud, account takeovers, fake accounts, and abuse. ([Demo](https://play.tirreno.com/), [Source Code](https://github.com/TirrenoTechnologies/tirreno)) `AGPL-3.0` `PHP`
