...
- [Gabe](https://scolliq.github.io/gabe/) - Lightweight cron job heartbeat monitor with webhook alerts, runs on Cloudflare Workers. ([Source Code](https://github.com/Scolliq/gabe)) `MIT` `JavaScript`
