...
- [NSL Mesh Router](https://nsl.sh) - Mesh networking and routing management system providing WireGuard VPN, automatic subdomain routing, and HTTPS termination for containerized applications. ([Source Code](https://github.com/Yundera/mesh-router-tunnel)) `MIT` `Docker`
