...
- [Open Archiver](https://github.com/LogicLabs-OU/OpenArchiver) - Email archiving solution with full-text search and eDiscovery search features. ([Source Code](https://github.com/LogicLabs-OU/OpenArchiver)) `AGPL-3.0` `TypeScript`
