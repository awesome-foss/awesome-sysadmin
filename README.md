...
- [Dar](http://dar.linux.free.fr/) - which stands for Disk ARchive, is a robust and rich featured archiving and backup software of the tar style. [Source Code](https://github.com/Edrusb/DAR), `GPLv2` `C++`
