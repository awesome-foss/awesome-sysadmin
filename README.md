...
- [Dokploy](https://dokploy.com/) - A stable, easy-to-use deployment solution designed to simplify the application management process. ([Source Code](https://github.com/Dokploy/dokploy)) `Apache-2.0` `Docker`
