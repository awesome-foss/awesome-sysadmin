...
- [Duplicacy Exporter](https://github.com/GeiserX/duplicacy-exporter) - Prometheus exporter for Duplicacy backup statistics with live speed, progress, and completion metrics. ([Source Code](https://github.com/GeiserX/duplicacy-exporter)) `GPL-3.0` `Python`
