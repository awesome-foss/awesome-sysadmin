...
*Monitoring software.*
  ...
  * [glances](https://nicolargo.github.io/glances/) - cross-platform monitoring tool which aims to present a maximum of information in a minimum of space through a curses or Web based interface. `LGPLv3` `Python`
