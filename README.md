...
- [InnerWarden](https://innerwarden.com) - Autonomous security agent with real-time threat detection and response via eBPF, 48 detectors and automated incident response. ([Source Code](https://github.com/InnerWarden/innerwarden)) `BUSL-1.1` `Rust`
