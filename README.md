...
- [Immortal](https://github.com/Nagendhra-web/Immortal) - Self-healing engine that monitors, detects failures, and auto-heals applications. Single binary, works offline, zero config. ([Source Code](https://github.com/Nagendhra-web/Immortal)) `Apache-2.0` `Go`
