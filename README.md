...
- [Linuxfabrik Monitoring Plugins](https://linuxfabrik.github.io/monitoring-plugins/) - 230+ Nagios-compatible check plugins for Icinga, Naemon, Nagios and friends, with auto-discovery, smart defaults and consistent cross-platform metrics on Linux, Windows, macOS and FreeBSD. ([Source Code](https://github.com/Linuxfabrik/monitoring-plugins)) `Unlicense` `Python`
