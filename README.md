...
- [onWatch](https://onwatch.onllm.dev/) - Multi-provider AI API quota tracker with web dashboard. ([Source Code](https://github.com/onllm-dev/onwatch)) `GPL-3.0` `Go/Docker`
