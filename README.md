...
- [Linuxfabrik LFOps](https://linuxfabrik.github.io/lfops/) - Ansible Collection with 145+ playbooks and 160+ roles to bootstrap and manage Linux infrastructure across RHEL 8/9/10, Debian and Ubuntu. ([Source Code](https://github.com/Linuxfabrik/lfops)) `Unlicense` `Python`
