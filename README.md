...
- [Semaphore](https://semaphore.io) - The Open Source CI/CD Platform. ([Source Code]([https://github.com/block8/phpci](https://docs.semaphoreci.com/CE/getting-started/install))) `Apache-2.0` `Elixir`
